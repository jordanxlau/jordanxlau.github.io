function App({lang}) {
  ...
  var intro = english ? "I recently finished my degree in Computer Science (with a minor in Linguistics) at uOttawa. I have done three internships as a software developer with the Government of Canada. I am a Dean's Honour List student and am proud to have been awarded the Merit Award Bursary and Canadian Hearing Services National Scholarship. My interests include swimming, karate, and languages."
  ...
  var tutoring_intro = english ? "In over 6 years, I have tutored everything from 2nd-grade French Immersion to Calculus and Vectors. I have always been an avid learner, so I now enjoy sharing my knowledge with younger students to help them succeed as well."
      ...
      <div class = "container-fluid px-0 py-0 text-white bg-secondary text-left">
          <div class = "row mx-0">
              ...
              <div class = "col-md-6 p-3">
                  ...
                  <p>{tutoring_intro}</p>
                  <br />
                  <a class = "btn btn-lg btn-outline-light" href = "downloadables/Jordan Lau Technical Resume.pdf" style={{margin: 3}} open>Developer Resume</a>
                  <a class = "btn btn-lg btn-outline-light" href = "downloadables/Jordan Lau Teaching Resume.pdf" style={{margin: 3}} open>Tutor Resume</a>
              </div>
          </div>
      </div>
  </>
