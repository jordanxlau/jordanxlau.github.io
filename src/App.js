function App({lang}) {
  ...
  var intro = english ? "I'm in my 4th year of Computer Science (with a minor in Linguistics) at uOttawa. I have done two internships as a software developer with the Government of Canada. I am a Dean's Honour List student and am proud to have been awarded the Merit Award Bursary and Canadian Hearing Services National Scholarship. My interests include swimming, karate, and languages."
  : "Je suis en 4ième année d'Informatique à uOttawa avec une mineure en Linguistique. J'étais deux fois un stagiaire en développment de logiciels pour le Gouvernement Fédérale. Je suis membre des palmarès du doyen et fier d'avoir reçu la bourse « Merit Award Bursary » ainsi que La Bourse d'Études des SCO. Je pratique la natation et le karaté, et je m'intéresse aussi aux langues."
  var this_website = english ? "This Website" : "Ce Site";
  var this_website_explanation = english ? "This website showcases me as a student, programmer and tutor! I've written the whole site myself with the help of Bootstrap. The translation was done by me and is activated with JQuery. It is hosted with GitHub Pages."
  : "Ce site me présente comme étudiant, tuteur et développeur de logiciels! Je l'ai fait moi-même avec Bootstrap. La traduction est la mienne aussi, est elle est activée avec JQuery. Le site est publié sur GitHub Pages.";
      ...
      <div class = "container-fluid px-0 py-0 text-white bg-secondary text-left">
          <div class = "row mx-0">
              ...
              <div class = "col-md-6 p-3">
                  ...
                  <p>{tutoring_intro}</p>
                  <br />
                  <a class = "btn btn-lg btn-outline-light" href = "downloadables/Jordan Lau Technical Resume.pdf" open>Technical Resume</a>
                  <a class = "btn btn-lg btn-outline-light" href = "downloadables/Jordan Lau Teaching Resume.pdf" open>Teaching Resume</a>
              </div>
          </div>
      </div>
  </>
